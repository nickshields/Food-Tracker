...
//  FoodTracker
//
//  Created by Nick Shields on 2020-02-11.
    ...
    */
    ...
    private func saveMeals(){
        ...
        let isSuccessfulSave = try NSKeyedArchiver.archivedData(withRootObject: meals, requiringSecureCoding: false)
            ...
            os_log("Couldn't save your shit")
        }
    ...
    private func loadMeals() -> [Meal]? {
        do{
            ...
            if let meals = try NSKeyedUnarchiver.unarchiveTopLevelObjectWithData(rawdata) as! [Meal]? {
                return meals
            }
        }catch{
            os_log("Couldn't load your shit")
        }
        return nil
    }
